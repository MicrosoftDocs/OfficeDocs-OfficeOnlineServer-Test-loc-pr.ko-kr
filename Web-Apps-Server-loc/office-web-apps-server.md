---
title: Office Web Apps 서버
TOCTitle: '@NoTitle'
ms:assetid: e75c9827-f5ce-4099-a08c-b42fde72ea98
ms:mtpsurl: https://technet.microsoft.com/ko-kr/library/JJ219456(v=office.15)
ms:contentKeyID: 49643440
ms.date: 01/04/2018
...
**요약:** 새로 업데이트된 Office Web Apps 아키텍처에서 Office Web Apps 서버를 사용하는 데 도움이 되는 문서를 소개합니다.

**대상:** IT 전문가

![Office 2013 로고](images/Ee855124.a106e261-2cd0-43b7-af77-92de7e4b6fb9(Office.15).png "Office 2013 로고")다음 표의 문서를 사용하여Office Web Apps 및 SharePoint 2013을 포함하는 Office Web Apps 서버에 대해 파악할 수 있습니다.


### TechNet의 Office Web Apps 서버 및 SharePoint 2013을 포함하는 Office Web Apps 개요 문서
...
<tbody>
<tr class="odd">
<td><p><a href="deploy-the-infrastructure-office-web-apps-server.md">인프라 배포: Office Web Apps 서버</a></p></td>
<td><p>Office Web Apps 서버에서 조직의 온-프레미스 호스트에 대해 브라우저 기반 Office 기능을 제공하는 방법을 설명합니다.</p></td>
</tr>
<tr class="even">
<td><p><a href="use-office-web-apps-with-sharepoint-2013.md">SharePoint 2013과 함께 Office Web Apps 사용</a></p></td>
<td><p>Office Web Apps, 새로운 기능, 그리고 Office Web Apps Preview가 SharePoint Server 2013과 함께 온-프레미스에서 작동하는 방법에 대해 설명합니다.</p></td>
</tr>
<tr class="odd">
<td><p><a href="apply-software-updates-to-office-web-apps-server.md">Office Web Apps 서버에 소프트웨어 업데이트 적용</a></p></td>
<td><p>Office Web Apps 서버 팜에 소프트웨어 업데이트를 적용하는 방법에 대해 설명합니다.</p></td>
</tr>
</tbody>
</table>
...
<td><p>Office 2013 또는 Office 365 ProPlus용 설명서에 대한 의견을 제공하려면 페이지 아래쪽에 있는 <strong>이 페이지가 도움이 되었나요?</strong> 링크를 선택합니다. 그러면 의견이 설명서 팀으로 바로 전달됩니다.</p>

...
ms:mtpsurl: https://technet.microsoft.com/ko-kr/library/JJ219458(v=office.15)
ms:contentKeyID: 49643446
ms.date: 01/04/2018
mtps_version: v=office.15
ms.translationtype: HT
---

# 인프라 배포: Office Web Apps 서버
...
Office Web Apps 서버는 브라우저 기반 버전의 Word, PowerPoint, Excel 및 OneNote를 제공하는 새로운 Office 서버 제품입니다. 단일 Office Web Apps Server 팜이 SharePoint 2013, Lync Server 2013, Exchange Server 2013, 공유 폴더 및 웹 사이트를 통해 Office 파일에 액세스하는 사용자를 지원할 수 있습니다. 새롭게 제공되는 이 독립 실행형 배포 모델을 사용하는 경우 조직에 배포되어 있는 다른 Office Server 제품과는 독립적으로 Office Web Apps Server 팜에 대한 업데이트를 관리할 수 있습니다.

![Office 2013 로고](images/Ee855124.a106e261-2cd0-43b7-af77-92de7e4b6fb9(Office.15).png "Office 2013 로고")다음 표의 문서는 조직에서 온-프레미스로 Office Web Apps 서버를 구성하려는 IT 전문가를 위한 것입니다.

### TechNet의 Office Web Apps Server 관련 문서
...
<tbody>
<tr class="odd">
<td><p><a href="office-web-apps-server-overview.md">Office Web Apps 서버 개요</a></p></td>
<td><p>Office Web Apps 서버에서 조직의 온-프레미스 호스트에 대해 브라우저 기반 Office 기능을 제공하는 방법을 설명합니다.</p></td>
</tr>
<tr class="even">
<td><p><a href="plan-office-web-apps-server.md">Office Web Apps 서버 계획</a></p></td>
<td><p>HTTPS, 인증서, 가상화, 부하 분산, 토폴로지, 보안 등의 Office Web Apps 서버 요구 사항에 대해 설명합니다.</p></td>
</tr>
<tr class="odd">
<td><p><a href="deploy-office-web-apps-server.md">Office Web Apps 서버 배포</a></p></td>
<td><p>Office Web Apps 서버를 온-프레미스로 배포하는 방법을 설명합니다.</p></td>
</tr>
<tr class="even">
<td><p><a href="technical-reference-for-office-web-apps-server.md">Office Web Apps Server 기술 참조</a></p></td>
<td><p>Office Web Apps 서버 관련 기술 참조 문서를 소개합니다. 여기에는 OfficeWebApps Windows PowerShellcmdlet 도움말도 포함됩니다.</p></td>
</tr>
</tbody>
</table>
